...
public interface RequestDispatcher {
	...
	/**
	 * The name of the request attribute that should be set by the container
	 * when the {@link #forward(javax.servlet.ServletRequest, javax.servlet.ServletResponse)} method is
	...
	/**
	 * The name of the request attribute that should be set by the container
	 * when the {@link #include(javax.servlet.ServletRequest, javax.servlet.ServletResponse)} method is
	 ...
	 *
	 * @param request  a {@link javax.servlet.ServletRequest} object that represents the request
	 *                 the client makes of the servlet
	 * @param response a {@link javax.servlet.ServletResponse} object that represents the response
	 ...
	 * <p/>
	 * <p/>
	 * The {@link javax.servlet.ServletResponse} object has its path elements and parameters
	 ...
	 * classes that wrap them.
	 *
	 * @param request  a {@link javax.servlet.ServletRequest} object that contains the client's
	 *                 request
	 * @param response a {@link javax.servlet.ServletResponse} object that contains the servlet's
	 *                 response
	 * @throws javax.servlet.ServletException if the included resource throws this exception
