...
public class FormAuthenticator
	 ...
	 * @param config   Login configuration describing how authentication
	 *                 should be performed
	 * @throws java.io.IOException If the forward to the login page fails and the call
	 *                             to {@link javax.servlet.http.HttpServletResponse#sendError(int, String)}
	 ...
	 * @param config   Login configuration describing how authentication
	 *                 should be performed
	 * @throws java.io.IOException If the forward to the error page fails and the call
	 *                             to {@link javax.servlet.http.HttpServletResponse#sendError(int, String)}
	 *                             throws an {@link java.io.IOException}
	 */
