...
public class SingleSignOn extends ValveBase implements SessionListener {
	 ...
	 * {@link org.apache.catalina.connector.Request#setAuthType Request.setAuthType()} and
	 * {@link org.apache.catalina.connector.Request#setUserPrincipal Request.setUserPrincipal()}
	 * </p>
	 *
