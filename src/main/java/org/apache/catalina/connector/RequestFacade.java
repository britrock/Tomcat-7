...
public class RequestFacade implements HttpServletRequest {
	 ...
	 * javax.servlet.http.HttpServletResponse#SC_SWITCHING_PROTOCOLS} and flushes the response.
	 ...
	 *                connection.
	 * @throws java.io.IOException If the upgrade fails (e.g. if the response has
