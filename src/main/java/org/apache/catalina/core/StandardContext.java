...
public class StandardContext extends ContainerBase
	 ...
	 * added via the {@link javax.servlet.ServletContext} possibly both before and after those
	...
	/**
	 * Context level override for default {@link org.apache.catalina.core.StandardHost#isCopyXML()}.
	 */
	...
	private static final class ContextFilterMaps {
		 ...
		 * added via the {@link javax.servlet.ServletContext} possibly both before and after
		 * those defined in the deployment descriptor.
		 */
		private FilterMap[] array = new FilterMap[0];

		/**
		 * Filter mappings added via {@link javax.servlet.ServletContext} may have to be
		 * inserted before the mappings in the deployment descriptor but must be
		 * inserted in the order the {@link javax.servlet.ServletContext} methods are called.
