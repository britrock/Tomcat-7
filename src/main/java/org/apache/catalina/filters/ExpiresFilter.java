 ...
 * <ul>
 * <li>
 * {@link #isEligibleToExpirationHeaderGeneration(javax.servlet.http.HttpServletRequest, org.apache.catalina.filters.ExpiresFilter.XHttpServletResponse)}
 * </li>
 * <li>
 * {@link #getExpirationDate(org.apache.catalina.filters.ExpiresFilter.XHttpServletResponse)}</li>
 * </ul>
 * </p>
...
public class ExpiresFilter extends FilterBase {
	...
	/**
	 * {@link java.util.regex.Pattern} for a comma delimited string that support whitespace
	 * characters
	 */
	...
	/**
	 * list of response status code for which the {@link org.apache.catalina.filters.ExpiresFilter} will not
	...
	/**
	 * <p>
	 * Returns the expiration date of the given {@link org.apache.catalina.filters.ExpiresFilter.XHttpServletResponse} or
	...
	/**
	 * <p>
	 * Returns the expiration date of the given {@link org.apache.catalina.filters.ExpiresFilter.ExpiresConfiguration},
	 * {@link javax.servlet.http.HttpServletRequest} and {@link org.apache.catalina.filters.ExpiresFilter.XHttpServletResponse}.
	 * </p>
	 * <p>
	 * <code>protected</code> for extension.
	 * </p>
	 ...
	 * been defined in the {@link org.apache.catalina.filters.ExpiresFilter} configuration, sets the '
	 ...
	 * {@link org.apache.juli.logging.Log#isDebugEnabled()} because
	 * {@link javax.servlet.http.HttpServletRequest#getRequestURI()} and
	 * {@link javax.servlet.http.HttpServletResponse#getContentType()} costs <tt>String</tt>
	 ...
	 * html-page/servlet-response was served ({@link org.apache.catalina.filters.ExpiresFilter.StartingPoint#ACCESS_TIME})
	 * or the last time the html-page/servlet-response was modified (
	 * {@link org.apache.catalina.filters.ExpiresFilter.StartingPoint#LAST_MODIFICATION_TIME}).
	 */
	...
	/**
	 * <p>
	 * Wrapping extension of the {@link javax.servlet.http.HttpServletResponse} to yrap the
	...
	/**
	 * Wrapping extension of {@link java.io.PrintWriter} to trap the
	 * "Start Write Response Body" event.
	 */
	...
	/**
	 * Wrapping extension of {@link javax.servlet.ServletOutputStream} to trap the
	 * "Start Write Response Body" event.
	 */
