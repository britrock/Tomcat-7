...
public class RemoteIpFilter implements Filter {
	...
	/**
	 * Wrap the incoming <code>request</code> in a {@link org.apache.catalina.filters.RemoteIpFilter.XForwardedRequest} if the http header <code>x-forwareded-for</code> is not empty.
	 */
	@Override
	 ...
	 * javax.servlet.ServletRequest#getLocalPort()} and {@link javax.servlet.ServletRequest#getServerPort()}
	 * wil be modified by this Filter rather than just
	 * {@link javax.servlet.ServletRequest#getServerPort()}.
	 * </p>
	 * <p>
