...
/**
 * This class is loaded by the {@link org.apache.catalina.loader.WebappClassLoader} to enable it to
 * deregister JDBC drivers forgotten by the web application. There are some
 * classloading hacks involved - see {@link org.apache.catalina.loader.WebappClassLoader#clearReferences()}
 * for details - but the short version is do not just create a new instance of
 * this class with the new keyword.
 * <p/>
 * Since this class is loaded by {@link org.apache.catalina.loader.WebappClassLoader}, it can not refer to
