...
public class ManagerServlet extends HttpServlet implements ContainerServlet {
	 ...
	 * @param writer Writer to render to
	 * @param cn     Name of the application to list session information for
	 * @deprecated Use {@link #sessions(java.io.PrintWriter, org.apache.catalina.util.ContextName, int,
	...
	/**
	 * @deprecated Use {@link org.apache.tomcat.util.res.StringManager#getManager(String, java.util.Enumeration)}.
