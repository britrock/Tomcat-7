...
public class MBeanUtils {
	 ...
	 * @throws javax.management.MalformedObjectNameException if a name cannot be created
	 * @deprecated Unused. Will be removed in Tomcat 8.0.x
	 */
	@Deprecated
	 ...
	 * {@link javax.management.ObjectName} to indicate that it is associated with that container.
	 *
