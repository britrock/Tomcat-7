...
public class JAASCallbackHandler implements CallbackHandler {
	 ...
	 * This implementation only recognizes {@link javax.security.auth.callback.NameCallback},
	 * {@link javax.security.auth.callback.PasswordCallback} and {@link javax.security.auth.callback.TextInputCallback}.
	 * {@link javax.security.auth.callback.TextInputCallback} is used to pass the various additional
	 * parameters required for DIGEST authentication.
	 *
	 * @param callbacks The set of <code>Callback</code>s to be processed
	 * @throws java.io.IOException                                       if an input/output error occurs
	 * @throws javax.security.auth.callback.UnsupportedCallbackException if the login method requests
