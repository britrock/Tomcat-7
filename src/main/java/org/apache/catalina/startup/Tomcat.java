...
public class Tomcat {
	...
	/**
	 * Static version of {@link #addServlet(String, String, javax.servlet.Servlet)}.
	 *
	 * @param ctx         Context to add Servlet to
	 * @param servletName Servlet name (used in mappings)
	 ...
	 * {@link Lifecycle} in order for the {@link org.apache.catalina.core.NamingContextListener} to be
	 * used.
	 */
