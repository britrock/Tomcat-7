 ...
 * at the bottom layer, the IO layer (for layers see the javadoc for the {@link org.apache.catalina.tribes.Channel} interface).<br>
...
public interface ChannelSender extends Heartbeat {
	 ...
	 *
	 * @throws java.io.IOException if preprocessing takes place and an error happens
	 */
	 ...
	 * @see ChannelException#addFaultyMember(org.apache.catalina.tribes.Member, Exception)
	 */
