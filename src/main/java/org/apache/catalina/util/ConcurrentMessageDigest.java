...
/**
 * A thread safe wrapper around {@link java.security.MessageDigest} that does not make use
...
public class ConcurrentMessageDigest {
	 ...
	 * @throws java.security.NoSuchAlgorithmException If the algorithm is not supported by the
	 *                                                JVM
	 */
