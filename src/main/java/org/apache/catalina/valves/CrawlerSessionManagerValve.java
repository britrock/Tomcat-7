...
public class CrawlerSessionManagerValve extends ValveBase
	...
	/**
	 * Specify the regular expression (using {@link java.util.regex.Pattern}) that will be used
	 * to identify crawlers based in the User-Agent header provided. The default
	 * is ".*GoogleBot.*|.*bingbot.*|.*Yahoo! Slurp.*"
	 *
	 * @param crawlerUserAgents The regular expression using {@link java.util.regex.Pattern}
	 */
