...
public abstract class StreamInbound implements UpgradeInbound {
	...
	/**
	 * This only applies to the {@link org.apache.catalina.websocket.WsOutbound} instance returned from
	 * {@link #getWsOutbound()} created by a subsequent call to
	 * {@link #setUpgradeOutbound(org.apache.coyote.http11.upgrade.UpgradeOutbound)}. The current
	 * {@link org.apache.catalina.websocket.WsOutbound} instance, if any, is not affected.
	 *
	 ...
	 * @throws java.io.IOException If a problem occurs processing the message. Any
