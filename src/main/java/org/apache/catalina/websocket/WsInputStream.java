 ...
 * makes the payload available for reading as an {@link java.io.InputStream}. It only
...
public class WsInputStream extends InputStream {
	 ...
	 * @throws java.io.IOException If a problem occurs reading the data for the frame.
	 */
