 ...
 * The {@link javax.el.FunctionMapper} is used at parse time, not evaluation time,
 * so one is not needed to evaluate an expression using this class.
 * However, the {@link javax.el.ELContext} is needed at evaluation time.</p>
 * <p/>
...
public final class MethodExpressionImpl extends MethodExpression implements
	 ...
	 * @throws javax.el.PropertyNotFoundException if one of the property resolutions failed because a specified
	 *                                            variable or property does not exist or is not readable.
	 * @throws javax.el.MethodNotFoundException   if no suitable method can be found.
	 * @throws javax.el.ELException               if an exception was thrown while performing property or
