...
public class Digester extends DefaultHandler2 {
	 ...
	 * @throws javax.xml.parsers.ParserConfigurationException if a parser configuration error
	 *                                                        occurs
	 * @throws org.xml.sax.SAXNotRecognizedException          if the property name is
	 *                                                        not recognized
	 * @throws org.xml.sax.SAXNotSupportedException           if the property name is
	 ...
	 *
	 * @throws org.xml.sax.SAXException if no XMLReader can be instantiated
	 */
	 ...
	 * @throws java.util.EmptyStackException if the named stack is empty
	 * @since 1.6
	 */
