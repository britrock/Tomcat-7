...
public class NioBlockingSelector {
	 ...
	 * @throws java.io.EOFException            if write returns -1
	 * @throws java.net.SocketTimeoutException if the write times out
	 * @throws java.io.IOException             if an IO Exception occurs in the underlying socket logic
	 */
	 ...
	 * @throws java.io.EOFException            if read returns -1
	 * @throws java.net.SocketTimeoutException if the read times out
	 * @throws java.io.IOException             if an IO Exception occurs in the underlying socket logic
	 */
