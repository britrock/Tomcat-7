...
//===========================================================================================
	 ...
	 * @throws java.io.IOException             - if an IO exception occurs or if application or network buffers contain data
	 ...
	 * @throws java.io.IOException if there is data on the outgoing network buffer and we are unable to flush it
