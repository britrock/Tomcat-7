...
public final class URL implements Serializable {
	 ...
	 * @throws java.net.MalformedURLException if the string representation
	 ...
	 * @throws java.net.MalformedURLException is never thrown, but present for
	 *                                        compatible APIs
	 ...
	 *
	 * @throws java.net.MalformedURLException if a normalization error occurs,
	 ...
	 * @throws java.net.MalformedURLException if a parsing error occurs
	 */
