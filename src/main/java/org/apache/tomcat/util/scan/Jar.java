...
public interface Jar {
	...
	/**
	 * Obtain an {@link java.io.InputStream} for a given entry in a JAR. The caller is
	 * responsible for closing the stream.
	 *
	 * @param name Entry to obtain an {@link java.io.InputStream} for
	 * @return An {@link java.io.InputStream} for the specified entry or null if
	 ...
	 * @throws java.io.IOException If the stream cannot be obtained
	 */
	 ...
	 * the JAR.
	 *
	 * @throws java.io.IOException If the pointer cannot be reset
	 */
