...
/**
 * In normal usage, this {@link javax.servlet.ServletContextListener} does not need to be
 * explicitly configured as the {@link org.apache.tomcat.websocket.server.WsSci} performs all the necessary
 * bootstrap and installs this listener in the {@link javax.servlet.ServletContext}. If the
 * {@link org.apache.tomcat.websocket.server.WsSci} is disabled, this listener must be added manually to every
