...
public class WsServerContainer extends WsWebSocketContainer
	 ...
	 * the specified configuration. {@link #WsServerContainer(javax.servlet.ServletContext)}
	...
	/**
	 * Provides the equivalent of {@link #addEndpoint(javax.websocket.server.ServerEndpointConfig)}
